...
public final class GoodreadsAnnotationExportAgentV3 {
    private GoodreadsAnnotationExportAgentV3() {}
    ...
    private static final class ExportRecord {
        ...
        private static ExportRecord from(Object start, Object end) throws Exception {
            ...
            int longOrder = record.startLong.compareTo(record.endLong);
            if (longOrder > 0 || (longOrder == 0 && record.startShort > record.endShort)) {
